...
mixin _$NotificationScheduleModel {
  ...
  $NotificationScheduleModelCopyWith<NotificationScheduleModel> get copyWith =>
      _$NotificationScheduleModelCopyWithImpl<NotificationScheduleModel>(
          this as NotificationScheduleModel, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, hour, minute, isEnabled, label);
...
abstract mixin class $NotificationScheduleModelCopyWith<$Res> {
  factory $NotificationScheduleModelCopyWith(NotificationScheduleModel value,
          $Res Function(NotificationScheduleModel) _then) =
      _$NotificationScheduleModelCopyWithImpl;
  @useResult
  $Res call({String id, int hour, int minute, bool isEnabled, String label});
}
...
extension NotificationScheduleModelPatterns on NotificationScheduleModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationScheduleModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NotificationScheduleModel() when $default != null:
        return $default(
            _that.id, _that.hour, _that.minute, _that.isEnabled, _that.label);
      case _:
        return orElse();
    }
  }
...
class _NotificationScheduleModel extends NotificationScheduleModel {
  const _NotificationScheduleModel(
      {required this.id,
      required this.hour,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationScheduleModelCopyWith<_NotificationScheduleModel>
      get copyWith =>
          __$NotificationScheduleModelCopyWithImpl<_NotificationScheduleModel>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationScheduleModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationScheduleModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.hour, hour) || other.hour == hour) &&
            (identical(other.minute, minute) || other.minute == minute) &&
            (identical(other.isEnabled, isEnabled) ||
...
/// @nodoc
abstract mixin class _$NotificationScheduleModelCopyWith<$Res>
    implements $NotificationScheduleModelCopyWith<$Res> {
  factory _$NotificationScheduleModelCopyWith(_NotificationScheduleModel value,
          $Res Function(_NotificationScheduleModel) _then) =
      __$NotificationScheduleModelCopyWithImpl;
  @override
  @useResult
  $Res call({String id, int hour, int minute, bool isEnabled, String label});
}
