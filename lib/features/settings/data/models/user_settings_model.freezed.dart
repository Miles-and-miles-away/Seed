...
mixin _$UserSettingsModel {
  ...
  List<NotificationScheduleModel> get reminderSchedules;
  ...
  Map<String, bool> get seenStreakMilestones;
  ...
  bool get streakGracePeriodUsed;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.reminderSchedules, reminderSchedules) &&
            (identical(other.smartRemindersEnabled, smartRemindersEnabled) ||
                other.smartRemindersEnabled == smartRemindersEnabled) &&
            (identical(other.language, language) ||
                other.language == language) &&
            (identical(other.hasSeenOnboarding, hasSeenOnboarding) ||
                other.hasSeenOnboarding == hasSeenOnboarding) &&
            const DeepCollectionEquality()
                .equals(other.seenStreakMilestones, seenStreakMilestones) &&
            (identical(other.streakGracePeriodUsed, streakGracePeriodUsed) ||
                other.streakGracePeriodUsed == streakGracePeriodUsed) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(reminderSchedules),
      smartRemindersEnabled,
      language,
      hasSeenOnboarding,
      const DeepCollectionEquality().hash(seenStreakMilestones),
...
abstract mixin class $UserSettingsModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<NotificationScheduleModel> reminderSchedules,
      bool smartRemindersEnabled,
      String language,
      bool hasSeenOnboarding,
      Map<String, bool> seenStreakMilestones,
      bool streakGracePeriodUsed,
...
class _$UserSettingsModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? reminderSchedules = null,
    Object? smartRemindersEnabled = null,
    Object? language = null,
    Object? hasSeenOnboarding = null,
    Object? seenStreakMilestones = null,
    Object? streakGracePeriodUsed = null,
    ...
    return _then(_self.copyWith(
      notificationsEnabled: null == notificationsEnabled
          ...
          : notificationsEnabled // ignore: cast_nullable_to_non_nullable
              as bool,
      reminderSchedules: null == reminderSchedules
          ? _self.reminderSchedules
          : reminderSchedules // ignore: cast_nullable_to_non_nullable
              as List<NotificationScheduleModel>,
      smartRemindersEnabled: null == smartRemindersEnabled
          ? _self.smartRemindersEnabled
          : smartRemindersEnabled // ignore: cast_nullable_to_non_nullable
              as bool,
      ...
      hasSeenOnboarding: null == hasSeenOnboarding
          ...
          : hasSeenOnboarding // ignore: cast_nullable_to_non_nullable
              as bool,
      seenStreakMilestones: null == seenStreakMilestones
          ? _self.seenStreakMilestones
          : seenStreakMilestones // ignore: cast_nullable_to_non_nullable
              as Map<String, bool>,
      streakGracePeriodUsed: null == streakGracePeriodUsed
          ? _self.streakGracePeriodUsed
          : streakGracePeriodUsed // ignore: cast_nullable_to_non_nullable
              as bool,
...
extension UserSettingsModelPatterns on UserSettingsModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserSettingsModel value)? $default, {
    ...
    switch (_that) {
      case _UserSettingsModel() when $default != null:
        return $default(
            ...
            _that.reminderSchedules,
            _that.smartRemindersEnabled,
            _that.language,
            _that.hasSeenOnboarding,
            _that.seenStreakMilestones,
            _that.streakGracePeriodUsed,
...
class _UserSettingsModel extends UserSettingsModel {
  const _UserSettingsModel(
      ...
      final List<NotificationScheduleModel> reminderSchedules = const [],
      this.smartRemindersEnabled = true,
      this.language = 'en',
      this.hasSeenOnboarding = false,
      final Map<String, bool> seenStreakMilestones = const {},
      this.streakGracePeriodUsed = false,
      this.analyticsEnabled = true})
      : _reminderSchedules = reminderSchedules,
        _seenStreakMilestones = seenStreakMilestones,
        super._();
  ...
  @JsonKey()
  List<NotificationScheduleModel> get reminderSchedules {
    if (_reminderSchedules is EqualUnmodifiableListView)
      return _reminderSchedules;
  ...
  @JsonKey()
  Map<String, bool> get seenStreakMilestones {
    if (_seenStreakMilestones is EqualUnmodifiableMapView)
      return _seenStreakMilestones;
    // ignore: implicit_dynamic_type
  ...
  @override
  @JsonKey()
  final bool streakGracePeriodUsed;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.notificationsEnabled, notificationsEnabled) ||
                other.notificationsEnabled == notificationsEnabled) &&
            const DeepCollectionEquality()
                .equals(other._reminderSchedules, _reminderSchedules) &&
            (identical(other.smartRemindersEnabled, smartRemindersEnabled) ||
                other.smartRemindersEnabled == smartRemindersEnabled) &&
            (identical(other.language, language) ||
                other.language == language) &&
            (identical(other.hasSeenOnboarding, hasSeenOnboarding) ||
                other.hasSeenOnboarding == hasSeenOnboarding) &&
            const DeepCollectionEquality()
                .equals(other._seenStreakMilestones, _seenStreakMilestones) &&
            (identical(other.streakGracePeriodUsed, streakGracePeriodUsed) ||
                other.streakGracePeriodUsed == streakGracePeriodUsed) &&
            (identical(other.analyticsEnabled, analyticsEnabled) ||
                other.analyticsEnabled == analyticsEnabled));
  ...
  int get hashCode => Object.hash(
      runtimeType,
      notificationsEnabled,
      const DeepCollectionEquality().hash(_reminderSchedules),
      smartRemindersEnabled,
      language,
      hasSeenOnboarding,
      const DeepCollectionEquality().hash(_seenStreakMilestones),
      streakGracePeriodUsed,
      analyticsEnabled);
