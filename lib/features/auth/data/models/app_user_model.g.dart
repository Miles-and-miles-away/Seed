...
_AppUserModel _$AppUserModelFromJson(Map<String, dynamic> json) =>
    _AppUserModel(
      ...
      mascots: (json['mascots'] as List<dynamic>?)
      ...
      eggPendingDiscoverySince: const TimestampConverter()
          .fromJson(json['eggPendingDiscoverySince'] as Timestamp?),
      ...
      sdgStats: (json['sdgStats'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(k, Map<String, int>.from(e as Map)),
          ) ??
          const {},
      viewedFactDates: (json['viewedFactDates'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      unlockedFactDates: (json['unlockedFactDates'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      ...
      recentChallengeIds: (json['recentChallengeIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      ...
      completedMultiDayChallenges:
          (json['completedMultiDayChallenges'] as List<dynamic>?)
                  ...
                  .toList() ??
              const [],
      ecodexDiscovered: (json['ecodexDiscovered'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      uniqueActionIds: (json['uniqueActionIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
Map<String, dynamic> _$AppUserModelToJson(_AppUserModel instance) =>
    <String, dynamic>{
      ...
      'eggPendingDiscoverySince':
          const TimestampConverter().toJson(instance.eggPendingDiscoverySince),
