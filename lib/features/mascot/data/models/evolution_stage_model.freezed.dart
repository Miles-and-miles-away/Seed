...
mixin _$EvolutionStageModel {
  ...
  $EvolutionStageModelCopyWith<EvolutionStageModel> get copyWith =>
      _$EvolutionStageModelCopyWithImpl<EvolutionStageModel>(
          this as EvolutionStageModel, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, level, assetPath, nameEn, nameJa, nameEs);

  @override
  String toString() {
    return 'EvolutionStageModel(level: $level, assetPath: $assetPath, nameEn: $nameEn, nameJa: $nameJa, nameEs: $nameEs)';
  }
}

/// @nodoc
abstract mixin class $EvolutionStageModelCopyWith<$Res> {
  factory $EvolutionStageModelCopyWith(
          EvolutionStageModel value, $Res Function(EvolutionStageModel) _then) =
      _$EvolutionStageModelCopyWithImpl;
  @useResult
  $Res call(
      {int level,
      String assetPath,
...
extension EvolutionStageModelPatterns on EvolutionStageModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EvolutionStageModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int level, String assetPath, String nameEn, String nameJa,
            String nameEs)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _EvolutionStageModel() when $default != null:
        return $default(_that.level, _that.assetPath, _that.nameEn,
            _that.nameJa, _that.nameEs);
      case _:
        return orElse();
    }
  }
...
class _EvolutionStageModel implements EvolutionStageModel {
  const _EvolutionStageModel(
      {required this.level,
      required this.assetPath,
      required this.nameEn,
      required this.nameJa,
      this.nameEs = ''});
  factory _EvolutionStageModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EvolutionStageModelCopyWith<_EvolutionStageModel> get copyWith =>
      __$EvolutionStageModelCopyWithImpl<_EvolutionStageModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EvolutionStageModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EvolutionStageModelCopyWith<$Res>
    implements $EvolutionStageModelCopyWith<$Res> {
  factory _$EvolutionStageModelCopyWith(_EvolutionStageModel value,
          $Res Function(_EvolutionStageModel) _then) =
      __$EvolutionStageModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int level,
