...
/// Date string in YYYY-MM-DD format (document ID)
 String get date;/// Number of goals completed today
 int get goalCount;/// List of completed SDG numbers (1-17, deduplicated)
 List<int> get completedSdgs;/// Total points earned today
 int get totalPoints;/// Total CO2 saved in grams today
 int get totalCo2Grams;/// CO2 saved in grams today, broken down by action category.
...
/// (e.g., `categoryCo2Grams.transport`).
 Map<String, int> get categoryCo2Grams;/// When this summary was created
@TimestampConverter() DateTime? get createdAt;/// When this summary was last updated
...
@useResult
$Res call({
 String date, int goalCount, List<int> completedSdgs, int totalPoints, int totalCo2Grams, Map<String, int> categoryCo2Grams,@TimestampConverter() DateTime? createdAt,@TimestampConverter() DateTime? updatedAt
});
...
as List<int>,totalPoints: null == totalPoints ? _self.totalPoints : totalPoints // ignore: cast_nullable_to_non_nullable
as int,totalCo2Grams: null == totalCo2Grams ? _self.totalCo2Grams : totalCo2Grams // ignore: cast_nullable_to_non_nullable
as int,categoryCo2Grams: null == categoryCo2Grams ? _self.categoryCo2Grams : categoryCo2Grams // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String date,  int goalCount,  List<int> completedSdgs,  int totalPoints,  int totalCo2Grams,  Map<String, int> categoryCo2Grams, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DailySummaryModel() when $default != null:
return $default(_that.date,_that.goalCount,_that.completedSdgs,_that.totalPoints,_that.totalCo2Grams,_that.categoryCo2Grams,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String date,  int goalCount,  List<int> completedSdgs,  int totalPoints,  int totalCo2Grams,  Map<String, int> categoryCo2Grams, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _DailySummaryModel():
return $default(_that.date,_that.goalCount,_that.completedSdgs,_that.totalPoints,_that.totalCo2Grams,_that.categoryCo2Grams,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String date,  int goalCount,  List<int> completedSdgs,  int totalPoints,  int totalCo2Grams,  Map<String, int> categoryCo2Grams, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _DailySummaryModel() when $default != null:
return $default(_that.date,_that.goalCount,_that.completedSdgs,_that.totalPoints,_that.totalCo2Grams,_that.categoryCo2Grams,_that.createdAt,_that.updatedAt);case _:
  return null;
...
@override@JsonKey() final  int goalCount;
/// List of completed SDG numbers (1-17, deduplicated)
 final  List<int> _completedSdgs;
/// List of completed SDG numbers (1-17, deduplicated)
@override@JsonKey() List<int> get completedSdgs {
...
/// updates work via FieldValue.increment on a specific key
/// (e.g., `categoryCo2Grams.transport`).
@override@JsonKey() Map<String, int> get categoryCo2Grams {
...
/// Create a copy of DailySummaryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? goalCount = null,Object? completedSdgs = null,Object? totalPoints = null,Object? totalCo2Grams = null,Object? categoryCo2Grams = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_DailySummaryModel(
date: null == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
as String,goalCount: null == goalCount ? _self.goalCount : goalCount // ignore: cast_nullable_to_non_nullable
as int,completedSdgs: null == completedSdgs ? _self._completedSdgs : completedSdgs // ignore: cast_nullable_to_non_nullable
as List<int>,totalPoints: null == totalPoints ? _self.totalPoints : totalPoints // ignore: cast_nullable_to_non_nullable
as int,totalCo2Grams: null == totalCo2Grams ? _self.totalCo2Grams : totalCo2Grams // ignore: cast_nullable_to_non_nullable
as int,categoryCo2Grams: null == categoryCo2Grams ? _self._categoryCo2Grams : categoryCo2Grams // ignore: cast_nullable_to_non_nullable
as Map<String, int>,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
