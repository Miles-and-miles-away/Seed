...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get foodGroupNutsSeeds => 'ナッツ・種実';

  @override
  String get foodGroupCondiments => '調味料';

  @override
  String get foodGroupPrepared => '調理済み食品';

  @override
  String get foodBasisDry => '乾燥重量 — 調理・浸水する前の重さで入力してください。';

  @override
  String get foodBasisDrained => '固形量 — 缶の汁を切った後の重さで入力してください。';

  @override
  String get foodBasisEdible => '可食部の重量 — 殻・骨・皮を除いた重さで入力してください。';

  @override
  String get foodBasisConcentrate => '希釈前の重量 — 濃縮された状態の重さで入力してください。';

  @override
  String get foodBoundaryNarrower =>
      '他の多くの食品より短いサプライチェーンで算出されているため、比較すると低めに見えます。';
  ...
  String get foodComparisonTooClose =>
      'この2つは差が小さすぎて判定できません。差が20%未満の場合、その差は元になる研究で区別できる範囲に収まるため、どちらが良いかは示さず、両方の合計のみを表示します。';
