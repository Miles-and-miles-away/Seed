...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'One typical use of each behaviour, largest first, as a multiple of the energy in an hour of LED light. Each row names its own basis (a use, an hour or a day) under the name. This ranks energy used, which is the part your habits decide.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'One typical use of each behaviour, largest first, as a multiple of the energy in {anchorUnit}. This ranks energy used, and the multiples hold on every grid.'**
