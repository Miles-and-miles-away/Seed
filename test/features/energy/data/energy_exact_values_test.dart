...
void main() {
  ...
  test('every preset quantity ships exactly', () {
    ...
    const expected = <String, double>{
      ...
      'washup_electric/full_load': 1.0,
      'washup_electric/few_dishes': 0.25,
      'washup_gas/full_load': 1.0,
      'washup_gas/few_dishes': 0.25,
      ...
      'rice_keepwarm/four_hours': 4,
      'rice_keepwarm/overnight_10h': 10,
      'led_bulb/one_hour': 1,
